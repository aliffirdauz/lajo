        ...
        <div className="flex justify-between items-center cursor-pointer">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="collapsible-dropdown flex flex-col gap-2 relative">
                    ...
                    <div className="bg-white rounded-2xl text-black font-medium flex-col flex gap-1 absolute z-[999] right-0 top-[80px] min-w-[180px] hidden overflow-hidden"
                        ref={dropdownTarget}>
                        ...
                        <Link href={route('logout')} method="post" as="button" className="transition-all hover:bg-sky-100 p-4 flex justify-start">Sign Out</Link>
                    </div>
                </div>
            </div>
            <style jsx="true">{`
